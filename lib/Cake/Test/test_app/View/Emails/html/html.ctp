...
<table>
	<th align="right" valign="top" style="font-weight: bold">The tag is across multiple lines - <?php echo str_repeat('x', CakeEmail::LINE_LENGTH_MUST); ?></th>
</table>
<p>Some more <?php echo str_repeat('x', CakeEmail::LINE_LENGTH_MUST); ?> <b>Bold</b>
	test.
</p>
