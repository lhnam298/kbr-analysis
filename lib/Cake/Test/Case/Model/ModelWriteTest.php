...
class ModelWriteTest extends BaseModelTest {
    ...
    public function testSaveAtomic() {
        ...
        $TestModel->create ();
        $result = $TestModel->save ( $data, array (
            'atomic' => false 
        ) );
    ...
    public function testSaveTransactionNoRollback() {
        ...
        $db = $this->getMock ( 'DboSource', array (
            'begin',
            'connect',
            'rollback',
            'describe' 
        ...
        $callback = array (
            $this,
            'callbackForTestSaveTransaction' 
        );
    ...
    public function testSaveTransaction() {
        ...
        $result = $PostModel->find ( 'all', array (
            'recursive' => - 1 
        ) );
        $expectedPosts = array (
            array (
        ...
        $PostModel->create ();
        $result = $PostModel->save ( $data, array (
            'atomic' => true 
        ) );
        $this->assertFalse ( $result );
        ...
        $result = $ArticleModel->find ( 'all', array (
            'recursive' => - 1 
        ) );
    ...
    public function testHabtmUuidWithUuidIdNative() {
        ...
        $data ['Uuidnativeitem'] ['Uuidnativeitem'] = array (
            '483798c8-c7cc-430e-8cf9-4fcc40cf8569' 
        );
        $TestModel->create ( $data );
        $TestModel->save ();
    ...
    public function testHabtmUuidWithNumericIdNative() {
        ...
        $data = array (
            'Uuidnativeitem' => array (
                'name' => 'Item 7',
                'published' => 0 
            ) 
        );
        $data ['Uuidnativeportfolio'] ['Uuidnativeportfolio'] = array (
            '480af662-eb8c-47d3-886b-230540cf8569' 
        );
        $TestModel->create ( $data );
        $TestModel->save ();
    ...
    public function testSaveAllManyRowsTransactionNoRollback() {
        ...
        $db = $this->_getMockDboSource ( array (
            'begin',
            'commit',
            'rollback' 
        ) );
    ...
    public function testSaveManyBooleanFields() {
        ...
        $result = $item->saveMany ( $data, array (
            'atomic' => false 
        ) );
    ...
    public function testSaveAssociatedHasOneBooleanFields() {
        ...
        $syfile->bindModel ( array (
            'hasOne' => array (
                'Item' 
            ) 
        ), false );
        $result = $syfile->saveAssociated ( $data, array (
            'atomic' => false 
        ) );
    ...
    public function testSaveAssociatedBelongsToBooleanFields() {
        ...
        $result = $item->saveAssociated ( $data, array (
            'atomic' => false 
        ) );
    ...
    public function testSafeUpdateMode() {
        ...
        $User->getEventManager ()->attach ( array (
            $this,
            'deleteMe' 
        ), 'Model.beforeSave' );
        ...
        $User->id = 2;
        $User->set ( array (
            'user' => $User->getDataSource ()->expression ( 'PDO_EXCEPTION()' ) 
        ) );
        try {
    ...
    public function deleteMe($event) {
        $Model = $event->subject;
        $Model->getDataSource ()->delete ( $Model, array (
    ...
    protected function _getMockDboSource($methods = array()) {
        ...
        foreach ( $passthrough as $method ) {
            $db->expects ( $this->any () )->method ( $method )->will ( $this->returnCallback ( array (
                $testDb,
                $method 
            ) ) );
        }
    ...
    public function testTransactionOnNestedSaveMany() {
        $this->loadFixtures ( 'Post' );
        $Post = new TestPost ();
        $Post->getEventManager ()->attach ( array (
            $this,
            'nestedSaveMany' 
        ), 'Model.afterSave' );
    ...
    public function testTransactionOnNestedSaveAssociated() {
        ...
        $Author->getEventManager ()->attach ( array (
            $this,
            'nestedSaveAssociated' 
        ), 'Model.afterSave' );
        ...
        $Author->dataForAfterSave = array (
            'Author' => array (
                'user' => 'inner',
                'password' => $db->expression ( 'PDO_EXCEPTION()' ) 
            ),
            'Post' => array (
                array (
                    'title' => 'Inner Post' 
    ...
    public function nestedSaveMany($event) {
        $Model = $event->subject;
        $Model->saveMany ( $Model->dataForAfterSave, array (
            'callbacks' => false 
        ) );
    }
    ...
    public function nestedSaveAssociated($event) {
        $Model = $event->subject;
        $Model->saveAssociated ( $Model->dataForAfterSave, array (
            'callbacks' => false 
        ) );
    }
}
