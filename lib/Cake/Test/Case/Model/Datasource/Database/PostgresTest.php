...
class PostgresTest extends CakeTestCase {
    ...
    public function testRegexpOperatorConditionsParsing() {
        ...
        $this->assertSame ( ' WHERE EXTRACT( \'YEAR\' FROM "User"."birthday" ) = 2015', $this->Dbo->conditions ( array (
            'EXTRACT( \'YEAR\' FROM User.birthday )' => 2015 
        ) ) );
    }
    ...
    public function testAlterSchemaTextToIntegerField() {
        ...
        $modified = $default;
        $modified ['text_fields'] ['active'] = array (
            'type' => 'integer',
            'null' => true 
        );
