...
class DboSourceTest extends CakeTestCase {
    ...
    public function testMagicMethodQuerying() {
        ...
        // findBy<X>And<Y>
        $result = $this->db->query ( 'findByFieldXAndFieldY', array (
            'x',
            'y' 
        ), $this->Model );
        $expected = array (
        ...
        // findBy<X>Or<Y>
        $result = $this->db->query ( 'findByFieldXOrFieldY', array (
            'x',
            'y' 
        ), $this->Model );
        $expected = array (
        ...
        $result = $this->db->query ( 'findMyFancySearchByFieldX', array (
            'x' 
        ), $this->Model );
        $expected = array (
            'myFancySearch',
        ...
        // findFirstBy<X>
        $result = $this->db->query ( 'findFirstByFieldX', array (
            'x' 
        ), $this->Model );
        $expected = array (
            'first',
        ...
        $result = $this->db->query ( 'findByFieldX', array (
            'x',
            'y',
            'priority',
            - 1 
        ...
        $result = $this->db->query ( 'findAllByFieldX', array (
            'x',
            'y',
            'priority',
            10,
        ...
        $result = $this->db->query ( 'findAllByFieldXAndFieldY', array (
            'x',
            'y',
            'z',
            'priority',
    ...
    public function testNotNullOnEnum() {
        ...
        $enumResult = $EnumTest->save ( array (
            'mood' => '' 
        ) );
    ...
    public function testDefaultConditions() {
        ...
        $this->assertEquals ( array (
            $db->fullTableName ( $Article, false ) . '.id' => 1 
        ), $result );
        
        // If conditions are supplied then they will be returned.
        $Article->id = 1;
        $result = $db->defaultConditions ( $Article, array (
    ...
    public function testCountAfterFindCalls() {
        ...
        $Primary = $this->getMock ( 'Comment', array (
            'afterFind' 
        ), array (
            array (
                'alias' => 'Primary' 
        ...
        $Article = $this->getMock ( 'Article', array (
            'afterFind' 
        ), array (), '', true );
        $User = $this->getMock ( 'User', array (
            'afterFind' 
        ), array (), '', true );
        $Comment = $this->getMock ( 'Comment', array (
            'afterFind' 
        ), array (), '', true );
        $Tag = $this->getMock ( 'Tag', array (
            'afterFind' 
        ), array (), '', true );
        $Attachment = $this->getMock ( 'Attachment', array (
            'afterFind' 
        ), array (), '', true );
        ...
        // primary = true
        $Primary->expects ( $this->once () )->method ( 'afterFind' )->with ( $this->anything (), $this->isTrue () )->will ( $this->returnArgument ( 0 ) );
...
method ( 'afterFind' )->with ( $this->anything (), $this->isFalse () )->will ( $this->returnArgument ( 0 ) );
        ...
        $result = $Primary->find ( 'first', array (
            'conditions' => array (
                'Primary.id' => 5 
            ),
            'recursive' => 2 
        ...
        // primary = true
        $User->expects ( $this->once () )->method ( 'afterFind' )->with ( $this->anything (), $this->isTrue () )->will ( $this->returnArgument ( 0 ) );
...
method ( 'afterFind' )->with ( $this->anything (), $this->isFalse () )->will ( $this->returnArgument ( 0 ) );
    ...
    public function testUseConsistentAfterFind() {
        ...
        $Author = new Author ();
        $Post = $this->getMock ( 'Post', array (
            'afterFind' 
        ), array (), '', true );
        $Post->expects ( $this->at ( 0 ) )->method ( 'afterFind' )->with ( array (
            array (
                'Post' => $expected ['Post'] [0] 
            ) 
        ), $this->isFalse () )->will ( $this->returnArgument ( 0 ) );
        $Post->expects ( $this->at ( 1 ) )->method ( 'afterFind' )->with ( array (
            array (
                'Post' => $expected ['Post'] [1] 
            ) 
        ), $this->isFalse () )->will ( $this->returnArgument ( 0 ) );
        
        $Author->bindModel ( array (
            'hasMany' => array (
                'Post' => array (
                    'limit' => 2,
                    'order' => 'Post.id' 
    ...
    public function testJoinsAfterFind() {
        ...
        $Article->expects ( $this->once () )->method ( 'afterFind' )->with ( array (
            0 => array (
                'Article' => array (
                    'id' => '1',
                    'user_id' => '1',
    ...
    public function testHasOneAfterFind() {
        ...
        $Article->expects ( $this->once () )->method ( 'afterFind' )->with ( $this->equalTo ( array (
            0 => array (
                'Article' => array (
                    'id' => '1',
                    'user_id' => '1',
