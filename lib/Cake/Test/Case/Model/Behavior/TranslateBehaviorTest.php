...
class TranslateBehaviorTest extends CakeTestCase {
    ...
    public function testSaveAssociatedAtomic() {
        ...
        $Mock = $this->getMockForModel ( 'TranslateTestModel', array (
            'save' 
        ) );
        ...
        $Mock->expects ( $this->at ( 0 ) )->method ( 'save' )->with ( $with, array (
            'atomic' => false 
        ) );
        ...
        $Mock->expects ( $this->at ( 1 ) )->method ( 'save' )->with ( $with, array (
            'atomic' => false 
        ) );
        
        $TestModel->create ();
        $TestModel->saveAssociated ( $data, array (
            'atomic' => false 
        ) );
    }
