...
class CakeTestCaseTest extends CakeTestCase {
    ...
    public function testAssertTagsRuntimeComplexity() {
        ...
        $input = '<div attr8="val8" attr6="val6" attr4="val4" attr2="val2"' . ' attr1="val1" attr3="val3" attr5="val5" attr7="val7" />' . 'My div' . '</div>';
        $this->assertTags ( $input, $pattern );
    }
    ...
    public function testGetMockForModelSecondaryDatasource() {
        ...
        $post = $this->getMockForModel ( 'SecondaryPost', array (
            'save' 
        ) );
    ...
    public function testGetMockForModelConstructorDatasource() {
        $post = $this->getMockForModel ( 'ConstructorPost', array (
            'save' 
        ), array (
            'ds' => 'test' 
        ) );
