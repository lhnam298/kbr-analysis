...
class FixtureTaskTest extends CakeTestCase {
    ...
    public function testImportRecordsFromDatabaseWithConditionsPoo() {
        ...
        $this->Task->expects ( $this->at ( 1 ) )->method ( 'in' )->with ( $this->anything (), $this->anything (), '3' )->will ( $this->returnValue ( '2' ) );
    ...
    public function testExecuteWithImportSchema() {
        ...
        $this->Task->expects ( $this->never () )->method ( 'in' );
        
        $this->Task->expects ( $this->at ( 0 ) )->method ( 'createFile' )->with ( $filename, $this->logicalAnd ( $this->stringContains ( 'class ArticleFixture' ), $this->stringContains ( "\$import = array('model' => 'Article'" ) ) );
    ...
    public function testExecuteWithImportRecords() {
        ...
        $this->Task->expects ( $this->at ( 0 ) )->method ( 'createFile' )->with ( $filename, $this->logicalAnd ( $this->stringContains ( 'class ArticleFixture' ), $this->stringContains ( "\$import = array('model' => 'Article', 'connection' => 'test')" ) ) );
