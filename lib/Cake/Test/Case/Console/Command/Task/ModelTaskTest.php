...
class ModelTaskTest extends CakeTestCase {
    ...
    public function testSkippingChoiceInteractiveFieldValidation() {
        $this->Task->initValidations ();
        $this->Task->interactive = true;
        $this->Task->expects ( $this->any () )->method ( 'in' )->will ( $this->onConsecutiveCalls ( '24', 'y', 's' ) );
    ...
    public function testSkippingAnotherInteractiveFieldValidation() {
        $this->Task->initValidations ();
        $this->Task->interactive = true;
        $this->Task->expects ( $this->any () )->method ( 'in' )->will ( $this->onConsecutiveCalls ( '24', 's' ) );
    ...
    public function testInteractiveDoValidationWithSkipping() {
        $this->Task->expects ( $this->any () )->method ( 'in' )->will ( $this->onConsecutiveCalls ( '35', '24', 'n', '10', 's' ) );
        $this->Task->interactive = true;
...
TEXT;
    ...
    public function testExecuteIntoAll() {
        ...
        $this->Task->expects ( $this->at ( 6 ) )->method ( 'createFile' )->with ( $filename, $this->stringContains ( 'class NumberTree' ) );
