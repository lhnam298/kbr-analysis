...
class ConsoleOutputTest extends CakeTestCase {
    ...
    public function testOverwrite() {
        ...
        $this->output->expects ( $this->at ( 0 ) )->method ( '_write' )->with ( $testString );
        
        $this->output->expects ( $this->at ( 1 ) )->method ( '_write' )->with ( "" );
        
        $this->output->expects ( $this->at ( 2 ) )->method ( '_write' )->with ( "Overwriting text" );
