...
class CakeResponseTest extends CakeTestCase {
    ...
    public function testSendContentLength() {
        ...
        ob_start ();
        $this->getMock ( 'CakeResponse', array (
            '_sendHeader',
            '_sendContent' 
        ) );
    ...
    public function corsData() {
        ...
        $secureRequest = $this->getMock ( 'CakeRequest', array (
            'is' 
        ) );
        $secureRequest->expects ( $this->any () )->method ( 'is' )->with ( 'ssl' )->will ( $this->returnValue ( true ) );
    ...
    public function testFile() {
        ...
        $response->expects ( $this->at ( 1 ) )->method ( 'header' )->with ( 'Accept-Ranges', 'bytes' );
        
        $response->expects ( $this->at ( 2 ) )->method ( 'header' )->with ( 'Content-Length', 38 );
    ...
    public function testFileWithUnknownFileTypeGeneric() {
        ...
        $response->expects ( $this->at ( 2 ) )->method ( 'header' )->with ( 'Content-Transfer-Encoding', 'binary' );
    ...
    public function testFileWithUnknownFileTypeOpera() {
        ...
        $response->expects ( $this->at ( 4 ) )->method ( 'header' )->with ( 'Accept-Ranges', 'bytes' );
    ...
    public function testFileRangeOffsetsNoDownload($range, $length, $offsetResponse) {
        ...
        $response->expects ( $this->at ( 2 ) )->method ( 'header' )->with ( array (
            'Content-Length' => $length,
            'Content-Range' => $offsetResponse 
        ) );
