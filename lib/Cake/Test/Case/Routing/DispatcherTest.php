...
class DispatcherTest extends CakeTestCase {
     ...
     *
     * @return void @triggers DispatcherTest $Dispatcher, array('request' => $request)
     */
     ...
     *
     * @return void @triggers DispatcherTest $Dispatcher, array('request' => $test)
     */
     ...
     *
     * @return void @triggers DispatcherTest $Dispatcher, array('request' => $url)
     */
