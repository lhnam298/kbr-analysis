...
class AssetDispatcherTest extends CakeTestCase {
     ...
     *
     * @return void @triggers DispatcherTest $this, compact('request', 'response')
    ...
    public function testNoHandleRoutedExtension() {
        ...
        Router::connect ( '/test_plugin/api/v1/:action', array (
            'controller' => 'api' 
        ) );
     ...
     *
     * @return void @triggers Dispatcher.beforeRequest $this, compact('request', 'response')
     */
