...
class MemcachedEngineTest extends CakeTestCase {
    ...
    public function testInvalidSerializerSetting() {
        ...
        $this->setExpectedException ( 'CacheException', 'invalid_serializer is not a valid serializer engine for Memcached' );
    ...
    public function testJsonSerializerSetting() {
        $this->skipIf ( ! Memcached::HAVE_JSON, 'Memcached extension is not compiled with json support' );
    ...
    public function testIgbinarySerializerSetting() {
        $this->skipIf ( ! Memcached::HAVE_IGBINARY, 'Memcached extension is not compiled with igbinary support' );
    ...
    public function testJsonSerializerThrowException() {
        $this->skipIf ( Memcached::HAVE_JSON, 'Memcached extension is compiled with json support' );
        ...
        $this->setExpectedException ( 'CacheException', 'Memcached extension is not compiled with json support' );
        $Memcached->init ( $settings );
    }
    ...
    public function testMsgpackSerializerThrowException() {
        $this->skipIf ( defined ( 'Memcached::HAVE_MSGPACK' ) && Memcached::HAVE_MSGPACK, 'Memcached extension is compiled with msgpack support' );
        ...
        $this->setExpectedException ( 'CacheException', 'msgpack is not a valid serializer engine for Memcached' );
        $Memcached->init ( $settings );
    }
    ...
    public function testIgbinarySerializerThrowException() {
        $this->skipIf ( Memcached::HAVE_IGBINARY, 'Memcached extension is compiled with igbinary support' );
        ...
        $this->setExpectedException ( 'CacheException', 'Memcached extension is not compiled with igbinary support' );
        $Memcached->init ( $settings );
    }
    ...
    public function testLongDurationEqualToZero() {
        ...
        $mock->expects ( $this->once () )->method ( 'set' )->with ( 'key', 'value', 0 );
