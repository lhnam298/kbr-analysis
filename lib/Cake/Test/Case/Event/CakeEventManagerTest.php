...
class CakeEventManagerTest extends CakeTestCase {
     ...
     *
     * @return void @triggers fake.event
     */
     ...
     *
     * @return void @triggers fake.event $this, array('some' => 'data')
     */
    ...
    public function testStopPropagation() {
        ...
        CakeEventManager::instance ( $generalManager );
        $generalManager->expects ( $this->any () )->method ( 'prioritisedListeners' )->with ( 'fake.event' )->will ( $this->returnValue ( array () ) );
     ...
     *
     * @return void @triggers fake.event $this
     */
