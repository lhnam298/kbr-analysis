...
class GenericObjectCollection extends ObjectCollection {
     ...
     *            The object to use
     * @param array $settings
     *            Settings to apply for the object
...
class ObjectCollectionTest extends CakeTestCase {
    ...
    public function testTriggerWithDisabledObjects() {
        $this->_makeMockClasses ();
        $this->Objects->setObject ( 'TriggerMockFirst', $this->FirstGenericObject );
        $this->Objects->setObject ( 'TriggerMockSecond', $this->SecondGenericObject, array (
            'enabled' => false 
        ) );
    ...
    public function testTriggerPriority() {
        ...
        $this->Objects->setObject ( 'TriggerMockThird', $this->ThirdGenericObject, array (
            'priority' => 7 
        ) );
     ...
     *
     * @return void @triggers callback $subjectClass, array('first argument')
     */
