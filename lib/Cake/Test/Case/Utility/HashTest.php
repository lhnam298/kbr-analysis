...
class HashTest extends CakeTestCase {
    ...
    public function testExtractWildcard() {
        $data = array (
            '02000009C5560001' => array (
                'name' => 'Mr. Alphanumeric' 
            ),
            '2300000918020101' => array (
                'name' => 'Mr. Numeric' 
            ),
            '390000096AB30001' => array (
                'name' => 'Mrs. Alphanumeric' 
            ),
            'stuff' => array (
                'name' => 'Ms. Word' 
            ),
    ...
    public function testSortNaturalIgnoreCase() {
        ...
        $result = Hash::sort ( $items, '{n}.Item.image', 'desc', array (
            'type' => 'natural',
            'ignoreCase' => true 
        ) );
        $expected = array (
        ...
        $result = Hash::sort ( $items, '{n}.Item.image', 'asc', array (
            'type' => 'natural',
            'ignoreCase' => true 
        ) );
        $expected = array (
    ...
    public function testSortStringIgnoreCase() {
        ...
        $sorted = Hash::sort ( $toSort, '{n}.Item.name', 'asc', array (
            'type' => 'string',
            'ignoreCase' => true 
        ) );
        $expected = array (
    ...
    public function testInsertSimple() {
        ...
        $result = Hash::insert ( $a, 'some.0123.path', array (
            'foo' => array (
                'bar' => 'baz' 
            ) 
        ) );
    ...
    public function testInsertMulti() {
        ...
        $result = Hash::insert ( $data, '{n}.Item[id=/\b2|\b4/]', array (
            'test' => 2 
        ) );
        $expected = array (
            0 => array (
