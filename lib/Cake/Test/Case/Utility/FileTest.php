...
class FileTest extends CakeTestCase {
     ...
     * testBasic method
     *
     * @return void @covers ::__construct
     *         @covers ::info
     *         @covers ::ext
     *         @covers ::name
     *         @covers ::md5
     ...
     *
     * @return void @covers ::replaceText
     */
