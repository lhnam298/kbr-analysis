...
class CakeTextTest extends CakeTestCase {
    ...
    public function testInsert() {
        ...
        $result = CakeText::insert ( "this is a ? string with a ? ? ?", array (
            'long',
            'few?',
            'params',
            'you know' 
        ...
        $result = CakeText::insert ( 'update saved_urls set url = :url where id = :id', array (
        ...
        $result = CakeText::insert ( ':me cake. :subject :verb fantastic.', array (
            'me' => 'I :verb',
            'subject' => 'cake',
            'verb' => 'is' 
        ) );
        ...
        $result = CakeText::insert ( ':I.am: :not.yet: passing.', array (
            'I.am' => 'We are' 
        ), array (
            'before' => ':',
            'after' => ':',
        ...
        $result = CakeText::insert ( '?-pended result', array (
            'Pre' 
        ) );
     ...
     * test Clean Insert
     *
     * @return void @covers ::cleanInsert
     */
    public function testCleanInsert() {
        ...
        $result = CakeText::cleanInsert ( '<p class=":missing" id=":missing">Text here</p>', array (
            'clean' => 'html',
            'before' => ':',
            'after' => '' 
        ) );
    ...
    public function testAutoIgnoreBadInsertData() {
        ...
        $result = CakeText::insert ( '(:foo > :bar || :fale!)', $data, array (
            'clean' => 'text' 
        ) );
...
TEXT;
        ...
        $result = CakeText::wrap ( $text, array (
            'width' => 20,
            'wordWrap' => false 
        ) );
...
<p><span style="font-size: medium;"><a>... </a></span></p>';
    ...
    public function testHighlightHtml() {
        ...
        $this->assertEquals ( $expected, $this->Text->highlight ( $text4, array (
            'strong',
            'what' 
        ), $options ) );
    }
