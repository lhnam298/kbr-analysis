...
class ValidationTest extends CakeTestCase {
    ...
    public function testCc() {
        ...
        $this->assertTrue ( Validation::cc ( '2221000000000009', array (
            'mc' 
        ) ) );
        $this->assertTrue ( Validation::cc ( '2720999999999996', array (
            'mc' 
        ) ) );
        $this->assertTrue ( Validation::cc ( '2223000010005798', array (
            'mc' 
        ) ) );
        $this->assertTrue ( Validation::cc ( '2623430710235708', array (
            'mc' 
        ) ) );
        $this->assertTrue ( Validation::cc ( '2420452519835723', array (
            'mc' 
        ) ) );
        // Solo 16
    ...
    public function testDateY() {
        ...
        $this->assertTrue ( Validation::date ( '1899', array (
            'y' 
        ) ) );
        ...
        $this->assertFalse ( Validation::date ( '1799', array (
            'y' 
        ) ) );
    }
    ...
    public function testInList() {
        ...
        $this->assertFalse ( Validation::inList ( '2x', array (
            1,
            2,
            3 
        ) ) );
        ...
        $this->assertFalse ( Validation::inList ( '0x7B', array (
            'ABC',
            '123' 
        ) ) );
        $this->assertFalse ( Validation::inList ( '0x7B', array (
