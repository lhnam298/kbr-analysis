...
class FormHelperTest extends CakeTestCase {
    ...
    public function testSecuredAndDisabled() {
        ...
        $this->Form->text ( 'Model.text2', array (
            'disabled' => 'disabled' 
        ) );
        $this->Form->password ( 'Model.password', array (
            'disabled' => true 
    ...
    public function testUnlockMultipleFieldRemovingFromFields() {
        ...
        $this->Form->hidden ( 'Order.id', array (
            'value' => 1 
        ) );
    ...
    public function testRadio() {
        ...
        $result = $this->Form->radio ( 'Model.multibyte', array (
            '男性' => '男性' 
        ) );
        $expected = array (
            'input' => array (
                'type' => 'hidden',
                'name' => 'data[Model][multibyte]',
                'id' => 'ModelMultibyte_',
                'value' => '' 
            ),
            array (
    ...
    public function testInputDateOptions() {
        ...
        $result = $this->Form->input ( 'date', array (
            'label' => false,
            'type' => 'day',
            'class' => 'form-control' 
        ) );
    ...
    public function testTextAreaMaxLength() {
        ...
        $result = $this->Form->input ( 'UserForm.stuff', array (
            'type' => 'textarea' 
        ) );
        $expected = array (
            'div' => array (
    ...
    public function testPostLinkSecurityHash() {
        $hash = Security::hash ( '/posts/delete/1' . serialize ( array () ) . '' . Configure::read ( 'Security.salt' ) );
        $hash .= '%3A';
    ...
    public function testPostLinkSecurityHashInline() {
        $hash = Security::hash ( '/basedir/posts/delete/1' . serialize ( array () ) . '' . Configure::read ( 'Security.salt' ) );
        $hash .= '%3A';
        ...
        $this->Form->postLink ( 'Delete', '/posts/delete/1', array (
            'inline' => false 
        ) );
        ...
        $this->assertAttributeEquals ( '/basedir/posts/add', '_lastAction', $this->Form, 'lastAction was should be restored.' );
    }
    ...
    public function testPostLinkFormBuffer() {
        ...
        $result = $this->Form->postLink ( 'Delete', '/posts/delete/2', array (
            'inline' => false,
            'method' => 'DELETE' 
        ) );
        $this->assertTags ( $result, array (
     ...
     * when the url option is undefined.
     * While the action parameter is deprecated
