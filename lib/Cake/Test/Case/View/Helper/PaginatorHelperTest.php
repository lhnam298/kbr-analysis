...
class PaginatorHelperTest extends CakeTestCase {
    ...
    public function testSortLinksWithLockOption() {
        ...
        $result = $this->Paginator->sort ( 'distance', null, array (
            'lock' => true 
        ) );
        $expected = array (
            'a' => array (
                'href' => '/officespace/accounts/index/param/sort:distance/direction:asc' 
            ),
            'Distance',
            '/a' 
        );
    ...
    public function testPagingLinks() {
        ...
        $result = $this->Paginator->prev ( '<i class="fa fa-angle-left"></i>', array (
            'escape' => false 
        ), null, array (
            'class' => 'prev disabled' 
        ) );
    ...
    public function testPagingLinksNotDefaultModel() {
        ...
        $expected = array (
            'a' => array (
                'href' => '/index/sort:title/direction:asc' 
            ),
            'Title',
            '/a' 
        );
