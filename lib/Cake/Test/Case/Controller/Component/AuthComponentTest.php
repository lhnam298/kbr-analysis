...
class TestAuthComponent extends AuthComponent {
     ...
     *
     * @param int $index
     *            The index at which to add/set the object
     * @param CakeObject $object
     *            The object to add/set
     * @return void
     */
     ...
     *
     * @param int $index
     *            The index at which to get the object
...
class AuthComponentTest extends CakeTestCase {
    ...
    public function testLoginAfterIdentify() {
        ...
        $auth->afterIdentifyCallable = array (
            $listener,
            'listenerFunction' 
        );
        $event = new CakeEvent ( 'Auth.afterIdentify', $this->Auth, array (
            'user' => $user 
        ) );
    ...
    public function testIsAuthorizedDelegation() {
        $AuthMockOneAuthorize = $this->getMock ( 'BaseAuthorize', array (
            'authorize' 
        ), array (), '', false );
        $AuthMockTwoAuthorize = $this->getMock ( 'BaseAuthorize', array (
            'authorize' 
        ), array (), '', false );
        $AuthMockThreeAuthorize = $this->getMock ( 'BaseAuthorize', array (
            'authorize' 
        ), array (), '', false );
        ...
        $AuthMockOneAuthorize->expects ( $this->once () )->method ( 'authorize' )->with ( array (
            'User' 
        ), $request )->will ( $this->returnValue ( false ) );
        
        $AuthMockTwoAuthorize->expects ( $this->once () )->method ( 'authorize' )->with ( array (
            'User' 
        ), $request )->will ( $this->returnValue ( true ) );
        
        $AuthMockThreeAuthorize->expects ( $this->never () )->method ( 'authorize' );
    ...
    public function testIsAuthorizedUsingUserInSession() {
        $AuthMockFourAuthorize = $this->getMock ( 'BaseAuthorize', array (
            'authorize' 
        ), array (), '', false );
        ...
        $AuthMockFourAuthorize->expects ( $this->once () )->method ( 'authorize' )->with ( $user, $request )->will ( $this->returnValue ( true ) );
    ...
    public function testRedirectToUnauthorizedRedirect() {
        ...
        $this->Auth->Flash = $this->getMock ( 'FlashComponent', array (
            'set' 
        ), array (
        ...
        $Controller->expects ( $this->once () )->method ( 'redirect' )->with ( $this->equalTo ( $expected ) );
        $this->Auth->Flash->expects ( $this->once () )->method ( 'set' );
        $this->Auth->startup ( $Controller );
    }
    ...
    public function testRedirectToUnauthorizedRedirectSuppressedAuthError() {
        ...
        $Controller->expects ( $this->once () )->method ( 'redirect' )->with ( $this->equalTo ( $expected ) );
        $this->Auth->Flash->expects ( $this->never () )->method ( 'set' );
        $this->Auth->startup ( $Controller );
    }
    ...
    public function testAjaxLogin() {
        ...
        $Dispatcher->dispatch ( new CakeRequest ( '/ajax_auth/add' ), $Response, array (
            'return' => 1 
        ) );
        $result = ob_get_clean ();
    ...
    public function testAjaxLoginResponseCode() {
        ...
        $this->Controller->response->expects ( $this->at ( 0 ) )->method ( '_sendHeader' )->with ( 'HTTP/1.1 403 Forbidden', null );
        $this->Auth->initialize ( $this->Controller );
    ...
    public function testLogoutTrigger() {
        $LogoutTriggerMockAuthenticate = $this->getMock ( 'BaseAuthenticate', array (
            'authenticate',
            'logout' 
        ), array (), '', false );
        ...
        $LogoutTriggerMockAuthenticate->expects ( $this->once () )->method ( 'logout' );
    ...
    public function testMapActions() {
        $MapActionMockAuthorize = $this->getMock ( 'BaseAuthorize', array (
            'authorize' 
        ), array (), '', false );
        $this->Auth->authorize = array (
            'MapActionAuthorize' 
    ...
    public function testMapActionsDelegation() {
        ...
        $this->Auth->setAuthorizeObject ( 0, $MapActionMockAuthorize );
        $MapActionMockAuthorize->expects ( $this->once () )->method ( 'mapActions' )->with ( array (
            'create' => array (
                'my_action' 
            ) 
        ) );
    ...
    public function testLoginWithRequestData() {
        ...
        $RequestLoginMockAuthenticate->expects ( $this->once () )->method ( 'authenticate' )->with ( $request )->will ( $this->returnValue ( $user ) );
    ...
    public function testFlashSettings() {
        ...
        $this->Auth->Flash->expects ( $this->once () )->method ( 'set' )->with ( 'Auth failure', array (
            'element' => 'custom',
            'params' => array (
                1 
            ),
