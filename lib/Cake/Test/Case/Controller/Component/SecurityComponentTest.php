...
class SecurityComponentTest extends CakeTestCase {
    ...
    public function setUp() {
        ...
        $request->expects ( $this->any () )->method ( 'here' )->will ( $this->returnValue ( '/posts/index' ) );
    ...
    public function testRequireAuthSucceed() {
        $_SERVER ['REQUEST_METHOD'] = 'AUTH';
        $this->Controller->Security->unlockedActions = array (
            'posted' 
        );
        $this->Controller->request ['action'] = 'posted';
        $this->Controller->Security->requireAuth ( 'posted' );
     ...
     *
     * @return void @triggers Controller.startup $this->Controller
     */
    ...
    public function testValidatePostDisabledFieldsInData() {
        ...
        $fields = urlencode ( Security::hash ( '/posts/index' . serialize ( $fields ) . $unlocked . Configure::read ( 'Security.salt' ) ) );
    ...
    public function testValidateNestedNumericSets() {
        ...
        $fields = urlencode ( Security::hash ( '/posts/index' . serialize ( $hashFields ) . $unlocked . Configure::read ( 'Security.salt' ), 'sha1' ) );
    ...
    public function testValidatePostUrlAsHashInput() {
        ...
        $request->expects ( $this->at ( 0 ) )->method ( 'here' )->will ( $this->returnValue ( '/posts/index?page=1' ) );
        $request->expects ( $this->at ( 1 ) )->method ( 'here' )->will ( $this->returnValue ( '/posts/edit/1' ) );
