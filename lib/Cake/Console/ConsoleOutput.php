...
class ConsoleOutput {
    ...
    public function __construct($stream = 'php://stdout') {
        ...
        if ((DS === '\\' && ! ( bool ) env ( 'ANSICON' ) && env ( 'ConEmuANSI' ) !== 'ON') || $stream === 'php://output' || (function_exists ( 'posix_isatty' ) && ! posix_isatty ( $this->_output ))) {
     ...
     *            Number of newlines to append.
     * @param int|null $size
     *            The number of bytes to overwrite. Defaults to the
