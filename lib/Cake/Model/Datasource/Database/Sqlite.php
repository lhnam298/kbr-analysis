...
class Sqlite extends DboSource {
    ...
    public function describe($model) {
        ...
        foreach ( $result as $column ) {
            ...
            if (in_array ( $fields [$column ['name']] ['type'], array (
                'timestamp',
                'datetime' 
            ) ) && strtoupper ( $fields [$column ['name']] ['default'] ) === 'CURRENT_TIMESTAMP') {
     ...
     * @param array $values
     *            The values to set columns to.
     * @param mixed $conditions
     *            array of conditions to use.
     * @return array
     */
     ...
     *
     * @param string $type
     *            The type of statement being rendered.
     * @param array $data
     *            The data to convert to SQL.
     * @return string
     */
