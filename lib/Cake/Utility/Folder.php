...
class Folder {
     ...
     *
     * @var int http://book.cakephp.org/2.0/en/core-utility-libraries/file-folder.html#Folder::$mode
     */
    public $mode = 0755;
    ...
    public static function isAbsolute($path) {
        ...
        return $path [0] === '/' || preg_match ( '/^[A-Z]:\\\\/i', $path ) || substr ( $path, 0, 2 ) === '\\\\' || static::isRegisteredStreamWrapper ( $path );
    }
     ...
     *            The directory structure to create. Either an absolute or relative
