...
class CakeEmail {
     ...
     *
     * @param string|bool|null $regex
     *            The pattern to use for email address validation,
    ...
    public function send($content = null) {
        ...
        if (! empty ( $this->_config ['log'] )) {
            ...
            CakeLog::write ( $config ['level'], PHP_EOL . $contents ['headers'] . PHP_EOL . PHP_EOL . $contents ['message'], $config ['scope'] );
        }
        return $contents;
    }
