...
class CakeResponse {
     ...
     *
     * @param bool $enable
     *            If null returns whether directive is set, if boolean
     ...
     *            Valid time string or DateTime object.
     * @return string
     */
     ...
     *            a single Vary string or an array
     ...
     *
     * @param string|DateTime $time
     *            Valid time string or unix timestamp or DateTime object.
     * @return DateTime
     */
     ...
     * @param string|array $allowedHeaders
     ...
     *
     * @param string $path
     *            Path to file. If the path is not an absolute path that resolves
