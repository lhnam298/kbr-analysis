...
class RequestHandlerComponent extends Component {
     ...
     *
     * @param bool $safe
     *            Use safe = false when you think the user might manipulate
    ...
    public function requestedWith($type = null) {
        if (! $this->request->is ( 'patch' ) && ! $this->request->is ( 'post' ) && ! $this->request->is ( 'put' ) && ! $this->request->is ( 'delete' )) {
            return null;
        }
        if (is_array ( $type )) {
            foreach ( $type as $t ) {
