...
class Controller extends CakeObject implements CakeEventListener {
     ...
     *
     * @return void @triggers Controller.initialize $this
     ...
     *
     * @return void @triggers Controller.shutdown $this
     */
     ...
     * @return \Cake\Network\Response|null @triggers Controller.beforeRedirect $this, array($url, $status, $exit)
     ...
     * Takes a list of models as a variable argument.
     * Example:
     *
